...
from garmentds.keypoint_detection.models.backbones.convnext_unet import ConvNeXtUnet
from garmentds.keypoint_detection.models.backbones.dilated_cnn import DilatedCnn
from garmentds.keypoint_detection.models.backbones.maxvit_unet import MaxVitPicoUnet, MaxVitUnet
from garmentds.keypoint_detection.models.backbones.mobilenetv3 import MobileNetV3
from garmentds.keypoint_detection.models.backbones.s3k import S3K
from garmentds.keypoint_detection.models.backbones.unet import Unet
...
class BackboneFactory:
    ...
    @staticmethod
    def create_backbone(cfg_model: omegaconf.DictConfig, **kwargs) -> Backbone:
        backbone_type = cfg_model.backbone
        for backbone_class in BackboneFactory.registered_backbone_classes:
            if backbone_type == backbone_class.__name__:
                return backbone_class(**(cfg_model.net[backbone_type]), **kwargs)
