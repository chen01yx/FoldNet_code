...
from garmentds.keypoint_detection.models.backbones.s3k import ResNetBlock
...
class Unet(Backbone):
    def __init__(self, **kwargs):
        ...
        n_channels_in = kwargs.get("n_channels_in", 3)
        n_downsampling_layers = kwargs.get("n_downsampling_layers", 2)
        n_resnet_blocks = kwargs.get("n_resnet_blocks", 3)
