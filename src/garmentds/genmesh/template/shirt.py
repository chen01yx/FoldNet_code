...
@dataclass
class ShirtCfg(GarmentCfgTypeA):
    """
    - sh = shoulder
    - cl = collar
    - nf = neck_f
    ...
    l_neck_f: Point2 = Point2(-0.01, +0.20)
    r_neck_f: Point2 = Point2(+0.01, +0.20)
    ...
    l_neck_f_o: Point2 = Point2(-0.03, +0.18)
    r_neck_f_o: Point2 = Point2(+0.03, +0.18)
    ...
    def symmetry(self):
        ...
        for keypoint in ["neck_b", "spine_bottom_b", "neck_b_o"]:
...
class Shirt(GarmentTypeA):
    _meta = dict(name="shirt")
    all_part_name_type = Literal["frontl", "frontr", "back", "leftf", "leftb", "rightf", "rightb", "collarfl", "collarfr", "collarb"]
    all_part = dict(
    ...
    all_edge: dict[all_part_name_type, list[GarmentBoundaryEdge]] = dict(
        frontl = [
            ...
            GarmentBoundaryEdge("l_neck_f", "l_bt_nf", "l_spine_bottom", True, connect=False, include="none"),
        ...
        frontr = [
            ...
            GarmentBoundaryEdge("r_corner", "r_cn_bt", "r_spine_bottom", False, connect=False, include="none"),
            GarmentBoundaryEdge("r_spine_bottom", "r_bt_nf", "r_neck_f", False, connect=False),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(cfg=utils.dataclass_init_from_dict(ShirtCfg, kwargs))
        self._cfg: ShirtCfg
        
    def _draw(self, width: int, height: int, xy2ij: Callable[[float, float], tuple[int, int]], cfg: ShirtCfg):
